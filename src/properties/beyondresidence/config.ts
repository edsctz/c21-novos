...
export const config: PropertyConfig = {
  ...
  gtmId: 'GTM-NKZQXB9J',
  seo: {
    title: 'Beyond Residence Alphaville - 3 suítes | Century 21 Alpha',
    ...
    keywords: ['apartamento alphaville', '3 suites alphaville', 'beyond residence', 'century 21 alpha', 'barueri']
  }
};
